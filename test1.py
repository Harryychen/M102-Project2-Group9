...
def eGreedy(e):
    ...
    print("expectedhappy eGreedy", totalhappye)
    #print(cafe_day);
...
def exploitOnly():
    ...
    print("expectedhappy exploitOnly", expectHappy)
    return expectHappy
    #print result:
    #print(totalHappy)
    #print(optimumHappy)
...
def exploreOnly():
    ...
    print("expectedhappy exploreonly", totalHappiness)
...
def simulation(e, t):
    ...
    while exploitcount < t:
        ...
        expectedHappyexploreonly = 100 * 9 + 100 * 7 + 100 * 11
        expectedexploitexploitonly = 9 + 7 + 11 + 297 *maxHappy
        expectedgreedy = 0
    print("averagegreedy", averagegreedy)
    print("averageexplore", averageexplore)
    print("averageexploit", averageexploit)